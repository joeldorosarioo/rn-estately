		...
		<View>
			<ScrollView showsVerticalScrollIndicator={false} contentContainerClassName="pb-32 bg-white">
				...
				<View className="px-5 mt-7 flex gap-2">
					<Text className="text-2xl font-rubik-extrabold">Cozy Beach House</Text>

					<View className="flex flex-row items-center gap-3">
						<View className="flex flex-row items-center px-4 py-2 bg-primary-100 rounded-full">
							<Text className="text-xs font-rubik-bold text-primary-300">House</Text>
						</View>
					...
					<View className="flex flex-row items-center mt-5">
						...
						<Text className="text-black-300 text-sm font-rubik-medium ml-2">8 Beds</Text>

						<View className="flex flex-row items-center justify-center bg-primary-100 rounded-full size-10 ml-7">
							<Image source={icons.bath} className="size-4" />
						</View>

						<Text className="text-black-300 text-sm font-rubik-medium ml-2">3 Baths</Text>

						<View className="flex flex-row items-center justify-center bg-primary-100 rounded-full size-10 ml-7">
							<Image source={icons.area} className="size-4" />
						</View>

						<Text className="text-black-300 text-sm font-rubik-medium ml-2">2000 sqft</Text>
					</View>
						...
						<View className="flex flex-row items-center justify-between mt-4">
							<View className="flex flex-row items-center">
								...
								<View className="flex flex-col items-start justify-center ml-3">
									<Text className="text-lg text-black-300 text-start font-rubik-bold">Joel Oliveira</Text>
									<Text className="text-sm text-black-200 text-start font-rubik-medium">mail@mail.com</Text>
								</View>
							</View>
						...
						{facilities.length > 0 && (
							<View className="flex flex-row flex-wrap items-start justify-start mt-2 gap-5">
								{facilities.map((item: any) => {
									const facility = facilities.find((facility) => facility.title === item.title);

									return (
										<View key={item.id.toString()} className="flex flex-1 flex-col items-center min-w-16 max-w-20">
					...
					<View className="mt-7">
						...
						<View className="flex flex-row items-center justify-start mt-4 gap-2">
							...
							<Text className="text-black-200 text-sm font-rubik-medium">Santorini, Greece</Text>
						</View>
			...
			<View className="absolute bg-white bottom-0 w-full rounded-t-2xl border-t border-r border-l border-primary-200 p-7">
				<View className="flex flex-row items-center justify-between gap-10">
					<View className="flex flex-col items-start">
						...
						<Text numberOfLines={1} className="text-primary-300 text-start text-2xl font-rubik-bold">$780</Text>
					</View>
